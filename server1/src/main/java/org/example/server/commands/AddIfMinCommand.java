...
public class AddIfMinCommand implements Command, Serializable {
    ...
    public boolean execute(String argument, Object objectArgument, User user) {
        try {
            ...
            } else ResponseOutputer.appendln("Значение солдата больше, чем значение наименьшего из солдат!");
    ...
    public String description() {
        return name + " - добавляет новый элемент в коллекцию, если его значение меньше, чем у наименьшего элемента этой коллекции";
    }
